...
Le backend lit le fichier CSV directement depuis Vercel Blob.

1. Uploader le fichier CSV dans Vercel Blob (via dashboard ou CLI) et récupérer l'URL du blob.

2. Configurer les variables d'environnement (ex: .env.local)

```env
ELECTEURS_BLOB_URL=https://.../electeurs.csv
